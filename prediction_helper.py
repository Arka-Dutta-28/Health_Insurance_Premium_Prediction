...
model_young = joblib.load("models/artifacts/model_young.joblib")
model_rest = joblib.load("models/artifacts/model_rest.joblib")
scaler_young = joblib.load("models/artifacts/scaler_young.joblib")
scaler_rest = joblib.load("models/artifacts/scaler_rest.joblib")
